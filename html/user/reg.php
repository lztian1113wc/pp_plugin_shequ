                    ...
                    <div class="layui-form layui-form-pane">
                        <form method="post">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="L_username" name="alias" required lay-verify="required" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
...
<script>
    ...
    layui.use('form',function(){
        ...
        form.on('submit(userreg)',function(data){
            ...
            var url = '<?php echo $zbp->host;?>zb_users/plugin/pp_plugin_shequ/html/user/cmd.php?act=reg';
            $.post(url,data.field,function(res){
                if('1'==res){
                    window.location.href='/shequ/user/login.html';
